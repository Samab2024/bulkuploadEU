...
charwhitelist = dict(email_address=string.ascii_letters + string.digits + "'-_.@", custom_id = string.ascii_letters + string.digits + '@.', app_id=string.digits, first_name=string.ascii_letters+string.digits+' -_,\'', last_name=string.ascii_letters+string.digits+' -_,\'')
