# -*- coding: utf-8 -*-
# VERACODE.SOURCE.CONFIDENTIAL.CTO-CloudAtlas-deploy.b5f7196e3c8d51cae90d11c2f37240654e19bcc09da964086d43ce67f1f200de
#
...
from veracode_api_signing.utils import get_host_from_url, get_path_from_url, get_scheme_from_url
...
def load_credentials_and_generate_hmac_header(http_method, url):
    ...
    # path is allowed to be case-sensitive (because path is sent along with the GET request)
    # http://stackoverflow.com/a/17113291/884640
